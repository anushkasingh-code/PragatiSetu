...
from sqlalchemy import Column, String, Float, DateTime, ForeignKey, JSON, Text, Enum, UniqueConstraint
...
class AuditRecord(Base):
    ...
    # Enforce one audit record per event at the DB level to prevent concurrent duplicates (BUG-002)
    __table_args__ = (
